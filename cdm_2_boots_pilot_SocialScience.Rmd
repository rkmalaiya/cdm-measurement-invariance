...
#df.X <- read_csv("..\\data\\FirstYearProject\\Exam4Trial1_X.csv") %>% mutate_all(as.integer) %>% bind_rows(
#  read_csv("..\\data\\FirstYearProject\\Exam4Trial2_X.csv") %>% mutate_all(as.integer)
#) 

df.Q <- read_csv("..\\data\\FirstYearProject\\Q.csv") %>% mutate_all(as.integer)

#df.Q <- read_csv("..\\data\\FirstYearProject\\Exam4Trial1_Q.csv") %>% mutate_all(as.integer) %>% bind_rows(
#  read_csv("..\\data\\FirstYearProject\\Exam4Trial2_Q.csv") %>% mutate_all(as.integer)
#) %>% distinct_all()
...
write_rds(df.data.sim.item, "..\\data\\FirstYearProject\\df_data_sim_item_socialscience.rds")
