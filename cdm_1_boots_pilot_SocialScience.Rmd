...
df.t <- get_mean_sample_error(X.p1, X.p2, sample_sizes[1], student_question_ratios[1],1)
...
for(i in 2:length(sample_sizes)) {
  ...
  df.t <- get_mean_sample_error(X.p1, X.p2, sample_sizes[i], student_question_ratios[i],1)
