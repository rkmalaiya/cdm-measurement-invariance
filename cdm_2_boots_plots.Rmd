...
```{r}
df.error.ec <- read_rds("..\\data\\FirstYearProject\\report\\df_error_ecpe.rds")

df.error.ec.agg <- read_rds("..\\data\\FirstYearProject\\report\\df_error_agg_ecpe.rds")

df.error.ec.fit <- read_rds("..\\data\\FirstYearProject\\report\\df_error_fit_ecpe.rds") %>% mutate(dataset = "ECPE")
...
```{r}
df.error.ti <- read_rds("..\\data\\FirstYearProject\\report\\df_error_timss.rds")

df.error.ti.agg <- read_rds("..\\data\\FirstYearProject\\report\\df_error_agg_timss.rds")

df.error.ti.fit <- read_rds("..\\data\\FirstYearProject\\report\\df_error_fit_timss.rds") %>% mutate(dataset = "TIMSS")
...
```{r}
df.error.ss <- read_rds("..\\data\\FirstYearProject\\report\\df_error_upsample_socialscience.rds")

df.error.ss.agg <- read_rds("..\\data\\FirstYearProject\\report\\df_error_agg_upsample_socialscience.rds")

df.error.ss.fit <- read_rds("..\\data\\FirstYearProject\\report\\df_error_fit_upsample_socialscience.rds") %>% mutate(dataset = "Social Psychology (Upsample)")
...
df.diff %>% ggplot() + 
  aes(x=avg_attempts, y = sd, fill = parameter) + 
  geom_col() + 
  facet_grid(dataset~parameter,scales = "free") + labs(x = "Average Student Attempts", y = "Standard Deviation", title = "Standard Deviation of Sampling Mean Difference") +
